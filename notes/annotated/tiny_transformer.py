...
# ---------------------------
# 0. Config
device = "cuda" if torch.cudda.is_available() else "cpu"
...
# --------------------------
# 1. Tiny toy dataset (manual)

text = """
This is a tiny Transformer language model experiment. 
It is trained on this small in-code dataset. 
My name is Billy, who is trying a bunch of models from basic to advanced.
I may replace this text with a bigger file or WikiText-2.
For now, I just want to see that the model trains and can generate something non-trivial. 
"""
...
def get_batch(split: str):
    ...
    y = torch.stack([source[i+1: i+block_size+1] for i in idx])
